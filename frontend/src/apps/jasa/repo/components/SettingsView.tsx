          ...
          <div className="flex items-center gap-3">
            {onLoadDummyData && (
              <button
                ...
                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm rounded-xl transition-all flex items-center gap-2"
              >
                🔄 Muat Data Dummy
              </button>
            )}
            <button
              ...
              className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-sm rounded-xl shadow-sm shadow-blue-500/30 transition-all flex items-center gap-2"
            >
