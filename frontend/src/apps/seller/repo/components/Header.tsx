...
const TAB_TITLES: Record<string, string> = {
  ...
  'katalog-diskon': 'Diskon & Promo',
  'katalog-harga': 'Harga Grosir & Member',
  'gudang': 'Stok Barang & Gudang',
  'gudang-multi': 'Manajemen Gudang Multi-Channel',
  'penerimaan-barang': 'Penerimaan Barang',
  'gudang-po': 'Purchase Order (PO)',
  'gudang-mutasi': 'Riwayat Mutasi Stok',
  'gudang-transfer': 'Transfer Antar Cabang',
  ...
  'keuangan-mutasi': 'Mutasi Kas & Antar Rekening',
  ...
  'laporan-konsinyasi': 'Laporan Konsinyasi',
  ...
  'marketplace-sync': 'Sinkronisasi Stok Real-Time',
  'marketplace-history': 'Riwayat Sinkronisasi',
  'shipping-dashboard': 'Dashboard Pengiriman',
  'shipping-management': 'Manajemen Kurir & Ekspedisi',
  'shipping-packing': 'Packing Station & Cetak AWB',
  ...
  'setting-staff': 'Data Staf & Pegawai',
  'setting-roles': 'Role & Hak Akses',
