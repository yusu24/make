      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xs border border-slate-200/80 dark:border-slate-700/80">
        <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto flex-1">
          <div className="relative flex-1 min-w-[200px] max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 h-[38px] bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl text-xs focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:text-white"
            />
          </div>
        ...
        <div className="shrink-0 w-full sm:w-auto flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-4 h-[38px] bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-500 shadow-xs transition-colors text-xs cursor-pointer w-full sm:w-auto justify-center"
          >
