    ...
    <div className="animate-fade-in retail-dashboard-spacing">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ marginBottom: 24 }}>
        ...
        <div className="bg-white rounded-xl border border-slate-200/80 p-4 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <div>
            <p className="text-2xl text-slate-900 leading-tight font-semibold">Rp {Number(summary.total_credit || 0).toLocaleString('id-ID', { maximumFractionDigits: 2 })}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200/80 p-4 flex flex-col gap-3 shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <div>
            <p className="text-2xl text-rose-600 leading-tight font-semibold">Rp {Number(summary.total_outstanding || 0).toLocaleString('id-ID', { maximumFractionDigits: 2 })}</p>
            ...
            {loading ? (
              ...
              paginatedData.map(r => (
                <tr key={r.id}>
                  ...
                  <td className="text-right">Rp {Number(r.total_amount || 0).toLocaleString('id-ID', { maximumFractionDigits: 2 })}</td>
                  <td className="text-right retail-text-secondary">Rp {Number(r.paid_amount || 0).toLocaleString('id-ID', { maximumFractionDigits: 2 })}</td>
                  <td className="text-right font-semibold">Rp {Number(r.remaining ?? (r.total_amount - r.paid_amount) || 0).toLocaleString('id-ID', { maximumFractionDigits: 2 })}</td>
