...
const FEATURES_BY_CATEGORY = {
  'toko-retail': {
    ...
    ai_advisor:      { label: 'Retail AI Advisor (Stockout & Reorder)', icon: '🤖' },
  ...
  'budidaya-hewan': {
    ...
    ai_diagnosis:    { label: 'AI Bio-Diagnosa & Smart Feeding (FCR)', icon: '🤖' },
  ...
  'budidaya-tanaman': {
    ...
    ai_diagnosis:    { label: 'Bio-AI Hama & Panen Presisi', icon: '🤖' },
  ...
  'kuliner': {
    ...
    ai_assistant:    { label: 'AI Chef Assistant & Resep HPP', icon: '🤖' },
  ...
  'jasa': {
    ...
    pos:             { label: 'Kasir POS Penjualan Cepat', icon: '🧾' },
    contracts:       { label: 'Kontrak Layanan Berkala (B2B)', icon: '📜' },
    ...
    finance:         { label: 'Keuangan Kas & Laba Rugi', icon: '💰' },
    accounting_pro:  { label: 'Akuntansi Neraca SAK EMKM & Jurnal', icon: '⚖️' },
    ai_diagnosis:    { label: 'AI Diagnosis & Auto Estimasi', icon: '🤖' },
    reports:         { label: 'Laporan Layanan & SLA Performa', icon: '📊' },
  ...
  'seller': {
    ...
    ai_advisor:      { label: 'AI E-Commerce Profit & Ad Optimizer', icon: '🤖' },
    reports:         { label: 'Laporan Penjualan & Laba', icon: '📊' },
