...
function processFile(filePath) {
    ...
    // Matches: <button ...> ... <span className="btn-text-mobile-hide">TEXT</span> ... </button>
    // Note: this is a simplistic regex that works for typical cases.
    ...
    content = content.replace(buttonRegex, (match, p1, p2, p3, p4) => {
        // p1 is the attributes of button
        // p3 is the text inside the span
