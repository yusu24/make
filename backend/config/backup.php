    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // App code already lives in git — only the actual uploaded
                // content (tenant logos, product images, etc.) needs backing
                // up here, not the whole project directory.
                'include' => [
        ...
        'destination' => [
             ...
             *
             * 'backups' is local-only for now. Once DigitalOcean Spaces (or
             * any S3-compatible target) credentials are set in .env, add
             * 's3' here too so every backup lands both on-disk and offsite.
             */
            'disks' => [
                'backups',
            ],
