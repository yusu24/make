...
class KulinerController extends Controller
{
    ...
    public function getSettings(Request $request)
    {
        ...
        return response()->json([
            ...
            'qris_image_url' => optional($settings)->qris_image_url ?? null,
            'bank_name' => optional($settings)->bank_name ?? null,
            'bank_account_no' => optional($settings)->bank_account_no ?? null,
            'bank_account_name' => optional($settings)->bank_account_name ?? null,
    ...
    public function getAdminSettings()
    {
        ...
        return response()->json([
            ...
            'qris_image_url' => optional($settings)->qris_image_url ?? '',
            'bank_name' => optional($settings)->bank_name ?? '',
            'bank_account_no' => optional($settings)->bank_account_no ?? '',
            'bank_account_name' => optional($settings)->bank_account_name ?? '',
        ...
        try {
            ...
            $settings = KulinerSetting::updateOrCreate(
                ...
                [
                    ...
                    'qris_image_url' => $request->qris_image_url,
