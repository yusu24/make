...
// Auto-cleanup: pembersihan akun demo sandbox (setiap 10 menit dan tepat jam 00:00 / 12 malam)
Schedule::command('demo:cleanup')->everyTenMinutes()->name('cleanup-demo-sandboxes')->withoutOverlapping();
Schedule::command('demo:cleanup')->daily()->at('00:00')->name('cleanup-demo-sandboxes-midnight')->withoutOverlapping();
